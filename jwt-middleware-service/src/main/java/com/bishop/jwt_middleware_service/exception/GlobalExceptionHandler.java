package com.bishop.jwt_middleware_service.exception;
...
import static com.bishop.jwt_middleware_service.config.ApplicationConstants.DEFAULT_HTTP_STATUS_CODE;
import static com.bishop.jwt_middleware_service.config.ApplicationConstants.DEFAULT_PROCESSING_FAILURE;
import static com.bishop.jwt_middleware_service.enums.TransactionStatus.FAILURE;
import static com.bishop.jwt_middleware_service.enums.TransactionStatus.TIMEOUT;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleCustomExceptions(CustomException e, WebRequest request) {
        ...
        TransactionResponseDto response = generateResponse(errorMessage, rrn);
    ...
    private TransactionResponseDto generateResponse(String errorMessage, String rrn) {
        ...
        transactionResponseDto.setRrn(rrn);
        transactionResponseDto.setStatus(errorStatus);
        transactionResponseDto.setResponseCode(errorCode);
        transactionResponseDto.setResponseDesc(errorMessage);
