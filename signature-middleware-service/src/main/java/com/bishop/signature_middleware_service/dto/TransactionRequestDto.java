package com.bishop.signature_middleware_service.dto;
...
public class TransactionRequestDto implements Serializable {
    ...
    @Pattern(regexp = "^[A-Z0-9_]{3,20}$", message = "Channel ID must be uppercase alphanumeric/underscored (e.g., OMNI_CHANNEL)")
    private String channelId;

    @NotBlank(message = "Signature must not be blank")
    @Pattern(regexp = "^[a-zA-Z0-9+/=]{20,512}$", message = "Signature format appears invalid")
