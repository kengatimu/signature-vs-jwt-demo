package com.bishop.signature_middleware_service.web.controller;
...
public class TransactionController {
    ...
    public ResponseEntity<?> processTransaction(@Valid @RequestBody TransactionRequestDto requestDto, BindingResult bindingResult, WebRequest webRequest) throws CustomException {
        ...
        try {
            ...
            TransactionResponseDto response = requestProcessorService.processTransactionRequestForSignature(rrn, requestDto, bindingResult, type);
